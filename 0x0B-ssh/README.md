...
* The advantage of using  <code speechify-initial-font-family="Menlo, Monaco, Consolas, &quot;Courier New&quot;, monospace" speechify-initial-font-size="12.6px">#!/usr/bin/env bash</code> instead of <code speechify-initial-font-family="Menlo, Monaco, Consolas, &quot;Courier New&quot;, monospace" speechify-initial-font-size="12.6px">/bin/bash</code> 
## Tasks
